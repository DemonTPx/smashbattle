...
const Character Player::CHARACTERS[Player::CHARACTER_COUNT] = {
	...
	{(char *)"BERT",		(char *)"gfx/pbw-bert.bmp",			1, 1, 1, 1},
	{(char *)"JORDY", 		(char *)"gfx/pbw-jordy.bmp",		2, 0, 0, 2},
	{(char *)"TIM", 		(char *)"gfx/pbw-tim.bmp",			2, 1, 1, 0},
	{(char *)"JEROEN G",	(char *)"gfx/jeroen.bmp",			1, 1, 1, 1},
	{(char *)"JEROEN S",	(char *)"gfx/pbw-jeroen-s.bmp",		0, 2, 0, 2},
	{(char *)"FRANK", 		(char *)"gfx/pbw-frank.bmp",		1, 2, 1, 0},
	{(char *)"MARC", 		(char *)"gfx/pbw-marc.bmp",			0, 2, 1, 1},
	{(char *)"MARTIJN",		(char *)"gfx/pbw-martijn.bmp",		0, 1, 2, 1},
	...
	{(char *)"JORN", 		(char *)"gfx/pbw-jorn.bmp",			1, 1, 0, 2},
	{(char *)"MENNO",		(char *)"gfx/pbw-menno.bmp",		0, 1, 2, 1},
	{(char *)"LISANNE",		(char *)"gfx/pbw-lisanne.bmp",		2, 1, 1, 0},
	{(char *)"JEROEN L",	(char *)"gfx/pbw-jeroen-l.bmp",		2, 1, 1, 0},
...
const Character Player::CHARACTERS[Player::CHARACTER_COUNT] = {
	...
	{(char *)"KOKU", 		(char *)"gfx/koen.bmp",			2, 0, 2, 0},
